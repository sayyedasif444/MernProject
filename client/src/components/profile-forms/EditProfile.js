...
const EditProfile = ({createProfile, getCurrentProfile, profile: {profile, loading,error }, history}) => {
    ...
    const {company, website, location, status, skills, githubusername, bio, twitter, facebook, youtube, instagram, linkedin} = formData;
