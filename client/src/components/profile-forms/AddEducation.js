    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={e=> {e.preventDefault(); addEducation(formData, history)}}>
                ...
                <div className="form-group">
                <p>
                    <input type="checkbox" name="current" value="" value={current} checked={current} onChange={e=>{setFormData({...formData, current: !current}); toggleDisabled(!toDateDisabled)}}/> Current School or Bootcamp
                </p>
                </div>
                <div className="form-group">
                <h4>To Date</h4>
